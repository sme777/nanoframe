...
#       e = g.make_edge(v1, v2)
#       s.add_edge(e)
#       s.to_json.should eq(JSON.generate({ "vertices": [{ "x": 99, "y": 99 }, { "x": -99, "y": -99 }],
#                                           "edges": [{ "v1": { "x": 99, "y": 99 }, "v2": { "x": -99, "y": -99 } }], "singelton": false }))
#     end
...
#                                           "sets": [
#                                             { "vertices": [{ "x": 1, "y": 0 }, { "x": 0, "y": 1 }], "edges": [],
#                                               "singelton": false },
#                                             { "vertices": [{ "x": 1, "y": 1 }],
#                                               "edges": [{ "v1": { "x": 0, "y": 1 }, "v2": { "x": 1, "y": 1 } }], "singelton": true }
#                                           ] }))
#     end
#   end
# end
