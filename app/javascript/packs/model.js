...
shape.addEventListener("click", function () {
  ...
  let setGuiElement = (func, obj) => {
    guiElements.push(
      gui
        .add(meshData, obj["property"], obj["min"], obj["max"])
        .step(obj["step"])
        .name(obj["title"])
        .setValue(obj["set"])
        .onChange(() => {
  ...
  if (chosenShape == 0) {
    ...
    guiElements.push(
      gui
        .add(meshData, "widthSegments", 0, 25)
        .step(1)
        .name("Width Segment")
        .setValue(10)
        .onChange(() => {
    ...
    guiElements.push(
      gui
        .add(meshData, "heightSegments", 0, 25)
        .step(1)
        .name("Height Segment")
        .setValue(8)
        .onChange(() => {
    ...
    guiElements.push(
      gui
        .add(meshData, "radialSegments", 2, 25)
        .name("Radial Segment")
        .setValue(12)
        .onChange(() => {
          Maker.makeCylinder(mesh);
    ...
    guiElements.push(
      gui
        .add(meshData, "radiusBottom", 0, 30)
        .name("Radius Bottom")
        .setValue(10)
        .onChange(() => {
          Maker.makeCylinder(mesh);
    ...
    guiElements.push(
      gui
        .add(meshData, "radialSegments", 2, 40)
        .step(1)
        .name("Radial Segment")
        .setValue(20)
        .onChange(() => {
    ...
    guiElements.push(
      gui
        .add(meshData, "radialSegments", 2, 30)
        .name("Radial Segment")
        .step(1)
        .setValue(8)
        .onChange(() => {
    ...
    guiElements.push(
      gui
        .add(meshData, "tubularSegments", 2, 50)
        .name("Tubular Segment")
        .step(1)
        .setValue(24)
        .onChange(() => {
          Maker.makeTorus(mesh);
    ...
    guiElements.push(
      gui
        .add(meshData, "tubularSegments", 2, 100)
        .name("Tubular Segment")
        .step(1)
        .setValue(64)
        .onChange(() => {
